...
The following text illustrates the XYZ format with an example.
\cite{XYZ_format}
...
Because of the 3D information in this format,  molecular visualization of proteins is possible using specialized software. 
In addition this it also contains information about atomic connectivity and the protein's primary,  secondary,  tertiary,  and quaternary structures.
...
SDF format file is a molecule description file that contains x,y,z format similar to PDB format.
It also contains atomic bond information.
This data can be used to create an atomic graph. Using this graph SMILES string can be generated.
...
We chose to use this format because we could extract the features of more molecules from this format.
