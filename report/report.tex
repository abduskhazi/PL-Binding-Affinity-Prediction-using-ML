...
it contains information regarding protein's primary, secondary, tertiary, and quaternary structures.
...
\begin{itemize}
\item Coefficient of determination, $R^2  \in (- \infty, 1.0]$ where $1.0$ is the best score. \cite{r_squared_score}
...
\item For visualizing the results given by our regression model,
